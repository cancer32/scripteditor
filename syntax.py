...
STYLES = {
    ...
    'import': format('darkviolet'),
    'string': format('magenta'),
    'string2': format('darkMagenta'),
    'comment': format('blue', 'italic'),
    'self': format('darkcyan'),
    'numbers': format('magenta'),
    'boolean': format('magenta'),
    'exception': format('darkgreen', 'bold'),
}
...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    exceptions = [
        ...
        "UnboundLocalError", "OSError", "BlockingIOError", "ChildProcessError", "ConnectionError", "BrokenPipeError",
        ...
        "UnicodeEncodeError", "UnicodeTranslateError", "Warning", "DeprecationWarning", "PendingDeprecationWarning",
        "RuntimeWarning", "SyntaxWarning", "UserWarning", "FutureWarning", "ImportWarning", "UnicodeWarning",
        "BytesWarning",
        "ResourceWarning",
    ]
    ...
    def __init__(self, document):
        ...
        rules += [(r'\b%s\b' % a, 0, STYLES['import'])
                  for a in PythonHighlighter.imports]
        rules += [(r'%s' % b, 0, STYLES['boolean'])
                  for b in PythonHighlighter.booleans]
        rules += [(r'%s' % c, 0, STYLES['exception'])
                  for c in PythonHighlighter.exceptions]
